...
class app:
    def __init__(self, master):
       ...
       #Load all icons
        self.connect_icon = ImageTk.PhotoImage(Image.open('Icons/connect_big.png'))
        self.upload_icon = ImageTk.PhotoImage(Image.open('Icons/upload_big.png'))
        self.download_icon = ImageTk.PhotoImage(Image.open('Icons/download_big.png'))
        self.newfolder_icon = ImageTk.PhotoImage(Image.open('Icons/newfolder_big.png'))
        self.up_icon = ImageTk.PhotoImage(Image.open('Icons/up_big.png'))
        self.info_icon = ImageTk.PhotoImage(Image.open('Icons/info_big.png'))
        self.delete_icon = ImageTk.PhotoImage(Image.open('Icons/delete_big.png'))
        self.properties_icon = ImageTk.PhotoImage(Image.open('Icons/properties_big.png'))
        self.cut_icon = ImageTk.PhotoImage(Image.open('Icons/cut_big.png'))
        self.copy_icon = ImageTk.PhotoImage(Image.open('Icons/copy_big.png'))
        self.paste_icon = ImageTk.PhotoImage(Image.open('Icons/paste_big.png'))
        self.permissions_icon = ImageTk.PhotoImage(Image.open('Icons/permissions_big.png'))
        ...
        self.console_icon = ImageTk.PhotoImage(Image.open('Icons/console_big.png'))
        self.search_icon = ImageTk.PhotoImage(Image.open('Icons/search_big.png'))
        self.rename_icon = ImageTk.PhotoImage(Image.open('Icons/rename_big.png'))
        self.whipFTP_icon = ImageTk.PhotoImage(Image.open('Icons/whipFTP_large.png'))
        self.goto_icon = ImageTk.PhotoImage(Image.open('Icons/gotopath_big.png'))

       #Load glow version of icons
        self.connect_glow_icon = ImageTk.PhotoImage(Image.open('Icons_glow/connect_big_glow.png'))
        self.upload_glow_icon = ImageTk.PhotoImage(Image.open('Icons_glow/upload_big_glow.png'))
        self.download_glow_icon = ImageTk.PhotoImage(Image.open('Icons_glow/download_big_glow.png'))
        self.newfolder_glow_icon = ImageTk.PhotoImage(Image.open('Icons_glow/newfolder_big_glow.png'))
        self.up_glow_icon = ImageTk.PhotoImage(Image.open('Icons_glow/up_big_glow.png'))
        self.info_glow_icon = ImageTk.PhotoImage(Image.open('Icons_glow/info_big_glow.png'))
        self.delete_glow_icon = ImageTk.PhotoImage(Image.open('Icons_glow/delete_big_glow.png'))
        self.properties_glow_icon = ImageTk.PhotoImage(Image.open('Icons_glow/properties_big_glow.png'))
        self.cut_glow_icon = ImageTk.PhotoImage(Image.open('Icons_glow/cut_big_glow.png'))
        self.copy_glow_icon = ImageTk.PhotoImage(Image.open('Icons_glow/copy_big_glow.png'))
        self.paste_glow_icon = ImageTk.PhotoImage(Image.open('Icons_glow/paste_big_glow.png'))
        self.console_glow_icon = ImageTk.PhotoImage(Image.open('Icons_glow/console_big_glow.png'))
        self.search_glow_icon = ImageTk.PhotoImage(Image.open('Icons_glow/search_big_glow.png'))
        self.whipFTP_glow_icon = ImageTk.PhotoImage(Image.open('Icons_glow/whipFTP_large_glow.png'))
        self.dnd_glow_icon = ImageTk.PhotoImage(Image.open('Icons_glow/upload_large_glow.png'))
        self.goto_glow_icon = ImageTk.PhotoImage(Image.open('Icons_glow/gotopath_big_glow.png'))
